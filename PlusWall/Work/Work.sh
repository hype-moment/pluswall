...
4-|V|5) feh --bg-fill ~/PlusWall/Work/4.png	;;
5-|VI|6) feh --bg-fill ~/PlusWall/Work/5.png	;;
6-|VII|7) feh --bg-fill ~/PlusWall/Work/6.png	;;
7-|VIII|8) feh --bg-fill ~/PlusWall/Work/7.png	;;
8-|IX|9) feh --bg-fill ~/PlusWall/Work/8.png	;;
9-|X|10) feh --bg-fill ~/PlusWall/Work/9.png	;;
